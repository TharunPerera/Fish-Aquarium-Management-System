...
import Fish_Ordering_Hard_code.Order;
import Fish_Ordering_Hard_code.CustomQueue;
...
public class OrderHistoryGUI extends JFrame {
      ...
      public OrderHistoryGUI(CustomQueue<Order> orderQueue) {
      ...
      public void populateTableModel() {
            ...
            while (!orderQueue.isEmpty()) {
                  ...
                  String telephoneNumber = order.getTelephoneNumber();
                  double totalCost = order.getTotalCost();

                  // Add order details to the table model
                  tableModel.addRow(new Object[]{orderID, telephoneNumber, totalCost});
            }
      }
      ...
      public static void main(String[] args) {
            ...
            CustomerInformationGUI customerGUI = new CustomerInformationGUI();
